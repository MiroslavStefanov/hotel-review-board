...
public final class WebConstants {
    ...
    public static final String HOME_URL = "/hotels";
    public static final String[] ANONYMOUS_URLS = {"/login", "/register"};
    public static final String[] PERMITTED_URLS = {"/css/**", "/scripts/**", "/assets/**", "/favicon.ico", "/hotel_api/search/findTop5ByOrderByPublishedAtDesc", ERROR_URL};
